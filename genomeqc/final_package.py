...
def main(outdir='output_genomeqc'):
    # 1. Make summary dir
    ...
    for src in glob.glob('output_genomeqc/*/'):
    ...
    for genus, folders in tqdm(genus_to_folders.items(), desc="Processing genera"):
        ...
        for csv_name, out_name in [
            ...
            src_csv = f'output_genomeqc/all_summary/{csv_name}'
        ...
        for folder in folders:
            src = os.path.join('output_genomeqc', folder)
