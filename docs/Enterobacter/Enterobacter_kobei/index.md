...
This is the GenomeQC page for *Enterobacter kobei*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Enterobacter/Enterobacter_kobei/Enterobacter_kobei_metrics.csv){.md-button}
...
[Download high quality genomes list](/Enterobacter/Enterobacter_kobei/Enterobacter_kobei_high_quality_genomes.csv.xz)


[Download rejected genomes list](/Enterobacter/Enterobacter_kobei/Enterobacter_kobei_filtered_out_genomes.csv.xz)
...
[Download full summary tables](/Enterobacter/Enterobacter_kobei/summary.csv)

[Download simple summary tables](/Enterobacter/Enterobacter_kobei/selected_summary.csv)
...
- [GC Content Histogram](Enterobacter_kobei_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Enterobacter_kobei_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Enterobacter_kobei_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Enterobacter_kobei_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Enterobacter_kobei_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Enterobacter_kobei_Genome_Size_refseq_qqplot.png)
