...
This is the GenomeQC page for *Neisseria meningitidis*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Neisseria/Neisseria_meningitidis/Neisseria_meningitidis_metrics.csv){.md-button}
...
[Download high quality genomes list](/Neisseria/Neisseria_meningitidis/Neisseria_meningitidis_high_quality_genomes.csv.xz)


[Download rejected genomes list](/Neisseria/Neisseria_meningitidis/Neisseria_meningitidis_filtered_out_genomes.csv.xz)
...
[Download full summary tables](/Neisseria/Neisseria_meningitidis/summary.csv)

[Download simple summary tables](/Neisseria/Neisseria_meningitidis/selected_summary.csv)
...
- [GC Content Histogram](Neisseria_meningitidis_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Neisseria_meningitidis_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Neisseria_meningitidis_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Neisseria_meningitidis_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Neisseria_meningitidis_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Neisseria_meningitidis_Genome_Size_refseq_qqplot.png)
