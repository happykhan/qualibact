...
This is the GenomeQC page for *Klebsiella aerogenes*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Klebsiella/Klebsiella_aerogenes/Klebsiella_aerogenes_metrics.csv){.md-button}
...
[Download full summary tables](/Klebsiella/Klebsiella_aerogenes/summary.csv)

[Download simple summary tables](/Klebsiella/Klebsiella_aerogenes/selected_summary.csv)
...
- [GC Content Histogram](Klebsiella_aerogenes_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Klebsiella_aerogenes_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Klebsiella_aerogenes_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Klebsiella_aerogenes_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Klebsiella_aerogenes_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Klebsiella_aerogenes_Genome_Size_refseq_qqplot.png)
