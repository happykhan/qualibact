...
This is the GenomeQC page for *Mycobacterium abscessus*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Mycobacterium/Mycobacterium_abscessus/Mycobacterium_abscessus_metrics.csv){.md-button}
...
[Download full summary tables](/Mycobacterium/Mycobacterium_abscessus/summary.csv)

[Download simple summary tables](/Mycobacterium/Mycobacterium_abscessus/selected_summary.csv)
...
- [GC Content Histogram](Mycobacterium_abscessus_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Mycobacterium_abscessus_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Mycobacterium_abscessus_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Mycobacterium_abscessus_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Mycobacterium_abscessus_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Mycobacterium_abscessus_Genome_Size_refseq_qqplot.png)
