...
This is the GenomeQC page for *Escherichia coli*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Escherichia/Escherichia_coli/Escherichia_coli_metrics.csv){.md-button}
...
[Download high quality genomes list](/Escherichia/Escherichia_coli/Escherichia_coli_high_quality_genomes.csv.xz)


[Download rejected genomes list](/Escherichia/Escherichia_coli/Escherichia_coli_filtered_out_genomes.csv.xz)
...
[Download full summary tables](/Escherichia/Escherichia_coli/summary.csv)

[Download simple summary tables](/Escherichia/Escherichia_coli/selected_summary.csv)
...
- [GC Content Histogram](Escherichia_coli_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Escherichia_coli_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Escherichia_coli_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Escherichia_coli_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Escherichia_coli_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Escherichia_coli_Genome_Size_refseq_qqplot.png)
