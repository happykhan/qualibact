...
This is the GenomeQC page for *Mycoplasmopsis bovis*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Mycoplasmopsis/Mycoplasmopsis_bovis/Mycoplasmopsis_bovis_metrics.csv){.md-button}
...
[Download high quality genomes list](/Mycoplasmopsis/Mycoplasmopsis_bovis/Mycoplasmopsis_bovis_high_quality_genomes.csv.xz)


[Download rejected genomes list](/Mycoplasmopsis/Mycoplasmopsis_bovis/Mycoplasmopsis_bovis_filtered_out_genomes.csv.xz)
...
[Download full summary tables](/Mycoplasmopsis/Mycoplasmopsis_bovis/summary.csv)

[Download simple summary tables](/Mycoplasmopsis/Mycoplasmopsis_bovis/selected_summary.csv)
...
- [GC Content Histogram](Mycoplasmopsis_bovis_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Mycoplasmopsis_bovis_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Mycoplasmopsis_bovis_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Mycoplasmopsis_bovis_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Mycoplasmopsis_bovis_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Mycoplasmopsis_bovis_Genome_Size_refseq_qqplot.png)
