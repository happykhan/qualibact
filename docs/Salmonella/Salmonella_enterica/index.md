...
This is the QualiBact page for *Salmonella enterica*. For detailed methods on how these thresholds were calculated, please see [Methods](../../methods.md).
...
These thresholds were applied to all the bacteria dataset, which resulted in removing **21033** and retaining **623670**.
...
![CDS vs Genome Size](Salmonella enterica_CDS_vs_Genome_Size.png)
