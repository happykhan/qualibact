...
This is the GenomeQC page for *Listeria innocua*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Listeria/Listeria_innocua/Listeria_innocua_metrics.csv){.md-button}
...
[Download high quality genomes list](/Listeria/Listeria_innocua/Listeria_innocua_high_quality_genomes.csv.xz)


[Download rejected genomes list](/Listeria/Listeria_innocua/Listeria_innocua_filtered_out_genomes.csv.xz)
...
[Download full summary tables](/Listeria/Listeria_innocua/summary.csv)

[Download simple summary tables](/Listeria/Listeria_innocua/selected_summary.csv)
...
- [GC Content Histogram](Listeria_innocua_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Listeria_innocua_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Listeria_innocua_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Listeria_innocua_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Listeria_innocua_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Listeria_innocua_Genome_Size_refseq_qqplot.png)
