...
This is the GenomeQC page for *Campylobacter jejuni*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Campylobacter/Campylobacter_jejuni/Campylobacter_jejuni_metrics.csv){.md-button}


These thresholds are based on **0** genomes from RefSeq and **94890** genomes from ATB / SRA.
...
[Download high quality genomes list](/Campylobacter/Campylobacter_jejuni/Campylobacter_jejuni_high_quality_genomes.csv.xz)


[Download rejected genomes list](/Campylobacter/Campylobacter_jejuni/Campylobacter_jejuni_filtered_out_genomes.csv.xz)
...
[Download full summary tables](/Campylobacter/Campylobacter_jejuni/summary.csv)

[Download simple summary tables](/Campylobacter/Campylobacter_jejuni/selected_summary.csv)
...
- [GC Content Histogram](Campylobacter_jejuni_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Campylobacter_jejuni_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Campylobacter_jejuni_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Campylobacter_jejuni_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Campylobacter_jejuni_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Campylobacter_jejuni_Genome_Size_refseq_qqplot.png)
