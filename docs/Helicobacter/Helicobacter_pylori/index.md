...
This is the QualiBact page for *Helicobacter pylori*. For detailed methods on how these thresholds were calculated, please see [Methods](../../methods.md).
...
![CDS vs Genome Size](Helicobacter pylori_CDS_vs_Genome_Size.png)
