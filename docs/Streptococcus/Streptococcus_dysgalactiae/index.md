...
This is the GenomeQC page for *Streptococcus dysgalactiae*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Streptococcus/Streptococcus_dysgalactiae/Streptococcus_dysgalactiae_metrics.csv){.md-button}


These thresholds are based on **0** genomes from RefSeq and **1603** genomes from ATB / SRA.
...
[Download full summary tables](/Streptococcus/Streptococcus_dysgalactiae/summary.csv)

[Download simple summary tables](/Streptococcus/Streptococcus_dysgalactiae/selected_summary.csv)
...
- [GC Content Histogram](Streptococcus_dysgalactiae_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Streptococcus_dysgalactiae_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Streptococcus_dysgalactiae_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Streptococcus_dysgalactiae_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Streptococcus_dysgalactiae_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Streptococcus_dysgalactiae_Genome_Size_refseq_qqplot.png)
