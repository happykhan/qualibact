...
This is the GenomeQC page for *Streptococcus equi*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Streptococcus/Streptococcus_equi/Streptococcus_equi_metrics.csv){.md-button}
...
[Download high quality genomes list](/Streptococcus/Streptococcus_equi/Streptococcus_equi_high_quality_genomes.csv.xz)


[Download rejected genomes list](/Streptococcus/Streptococcus_equi/Streptococcus_equi_filtered_out_genomes.csv.xz)
...
[Download full summary tables](/Streptococcus/Streptococcus_equi/summary.csv)

[Download simple summary tables](/Streptococcus/Streptococcus_equi/selected_summary.csv)
...
- [GC Content Histogram](Streptococcus_equi_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Streptococcus_equi_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Streptococcus_equi_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Streptococcus_equi_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Streptococcus_equi_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Streptococcus_equi_Genome_Size_refseq_qqplot.png)
