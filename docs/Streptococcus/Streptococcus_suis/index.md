...
This is the QualiBact page for *Streptococcus suis*. For detailed methods on how these thresholds were calculated, please see [Methods](../../methods.md).
...
![CDS vs Genome Size](Streptococcus suis_CDS_vs_Genome_Size.png)
