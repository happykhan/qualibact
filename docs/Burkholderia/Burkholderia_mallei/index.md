...
This is the GenomeQC page for *Burkholderia mallei*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Burkholderia/Burkholderia_mallei/Burkholderia_mallei_metrics.csv){.md-button}
...
[Download high quality genomes list](/Burkholderia/Burkholderia_mallei/Burkholderia_mallei_high_quality_genomes.csv.xz)


[Download rejected genomes list](/Burkholderia/Burkholderia_mallei/Burkholderia_mallei_filtered_out_genomes.csv.xz)
...
[Download full summary tables](/Burkholderia/Burkholderia_mallei/summary.csv)

[Download simple summary tables](/Burkholderia/Burkholderia_mallei/selected_summary.csv)
...
- [GC Content Histogram](Burkholderia_mallei_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Burkholderia_mallei_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Burkholderia_mallei_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Burkholderia_mallei_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Burkholderia_mallei_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Burkholderia_mallei_Genome_Size_refseq_qqplot.png)
