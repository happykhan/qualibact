...
This is the GenomeQC page for *Enterococcus faecalis*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Enterococcus/Enterococcus_faecalis/Enterococcus_faecalis_metrics.csv){.md-button}
...
[Download high quality genomes list](/Enterococcus/Enterococcus_faecalis/Enterococcus_faecalis_high_quality_genomes.csv.xz)


[Download rejected genomes list](/Enterococcus/Enterococcus_faecalis/Enterococcus_faecalis_filtered_out_genomes.csv.xz)
...
[Download full summary tables](/Enterococcus/Enterococcus_faecalis/summary.csv)

[Download simple summary tables](/Enterococcus/Enterococcus_faecalis/selected_summary.csv)
...
- [GC Content Histogram](Enterococcus_faecalis_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Enterococcus_faecalis_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Enterococcus_faecalis_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Enterococcus_faecalis_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Enterococcus_faecalis_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Enterococcus_faecalis_Genome_Size_refseq_qqplot.png)
