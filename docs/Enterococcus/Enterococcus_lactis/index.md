...
This is the GenomeQC page for *Enterococcus lactis*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Enterococcus/Enterococcus_lactis/Enterococcus_lactis_metrics.csv){.md-button}


These thresholds are based on **0** genomes from RefSeq and **1293** genomes from ATB / SRA.
...
[Download high quality genomes list](/Enterococcus/Enterococcus_lactis/Enterococcus_lactis_high_quality_genomes.csv.xz)


[Download rejected genomes list](/Enterococcus/Enterococcus_lactis/Enterococcus_lactis_filtered_out_genomes.csv.xz)
...
[Download full summary tables](/Enterococcus/Enterococcus_lactis/summary.csv)

[Download simple summary tables](/Enterococcus/Enterococcus_lactis/selected_summary.csv)
...
- [GC Content Histogram](Enterococcus_lactis_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Enterococcus_lactis_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Enterococcus_lactis_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Enterococcus_lactis_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Enterococcus_lactis_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Enterococcus_lactis_Genome_Size_refseq_qqplot.png)
