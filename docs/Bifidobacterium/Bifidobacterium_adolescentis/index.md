...
This is the GenomeQC page for *Bifidobacterium adolescentis*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Bifidobacterium/Bifidobacterium_adolescentis/Bifidobacterium_adolescentis_metrics.csv){.md-button}
...
[Download full summary tables](/Bifidobacterium/Bifidobacterium_adolescentis/summary.csv)

[Download simple summary tables](/Bifidobacterium/Bifidobacterium_adolescentis/selected_summary.csv)
...
- [GC Content Histogram](Bifidobacterium_adolescentis_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Bifidobacterium_adolescentis_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Bifidobacterium_adolescentis_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Bifidobacterium_adolescentis_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Bifidobacterium_adolescentis_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Bifidobacterium_adolescentis_Genome_Size_refseq_qqplot.png)
