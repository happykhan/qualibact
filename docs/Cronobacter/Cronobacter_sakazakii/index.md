...
This is the GenomeQC page for *Cronobacter sakazakii*. For detailed methods on how these thresholds were calculated, please see [Methods](/methods).
...
[Download metrics CSV](/Cronobacter/Cronobacter_sakazakii/Cronobacter_sakazakii_metrics.csv){.md-button}
...
[Download high quality genomes list](/Cronobacter/Cronobacter_sakazakii/Cronobacter_sakazakii_high_quality_genomes.csv.xz)


[Download rejected genomes list](/Cronobacter/Cronobacter_sakazakii/Cronobacter_sakazakii_filtered_out_genomes.csv.xz)
...
[Download full summary tables](/Cronobacter/Cronobacter_sakazakii/summary.csv)

[Download simple summary tables](/Cronobacter/Cronobacter_sakazakii/selected_summary.csv)
...
- [GC Content Histogram](Cronobacter_sakazakii_GC_Content_refseq_histogram_kde.png)
- [GC Content QQ Plot](Cronobacter_sakazakii_GC_Content_refseq_qqplot.png)
- [Total Coding Sequences Histogram](Cronobacter_sakazakii_Total_Coding_Sequences_refseq_histogram_kde.png)
- [Total Coding Sequences QQ Plot](Cronobacter_sakazakii_Total_Coding_Sequences_refseq_qqplot.png)
- [Genome Size Histogram](Cronobacter_sakazakii_Genome_Size_refseq_histogram_kde.png)
- [Genome Size QQ Plot](Cronobacter_sakazakii_Genome_Size_refseq_qqplot.png)
